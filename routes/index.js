        ...
        smtpTransport.sendMail(mailOptions, (err) => {
          ...
          req.flash(
            ...
            "An e-mail has been sent to " +
              user.username +
              " with further instructions. If you don't not receive the email please check your spam folder."
          );
          done(err, "done");
        });
      },
  ...
  loginIssue.create(
    ...
    (err, newloginIssue) => {
      if (err) {
        ...
        req.flash(
          "success",
          "Successfully registered complaint, you will hear back in 48hrs"
        );
        return res.redirect("/forgot");
      }
    }
